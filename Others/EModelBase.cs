...
public abstract class EModelBase : MonoBehaviour
{
    ...
    public void InitRigidBodies()
    {
        ...
        {
            if (((Component)(object)list[num]).gameObject.CompareTag("AudioRigidBody"))
            {
                list.RemoveAt(num);
            }
        }
        ...
        if (list.Count == 11)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    ((Component)(object)val).gameObject.GetOrAddComponent<CollisionCallForward>().Entity = entity;
                }
    ...
    public IKController AddIKController()
    {
        ...
        if ((bool)transform)
        {
            ...
            {
                iKController = ((Component)(object)componentInChildren).GetComponent<IKController>();
                if (!iKController)
                {
                    iKController = ((Component)(object)componentInChildren).gameObject.AddComponent<IKController>();
                }
            }
        }
    ...
    public void LookAtUpdate(EntityAlive e)
    {
        ...
        if (e.IsDead() || (currentStun != 0 && currentStun != EnumEntityStunType.Getup))
        {
            lookAtBlendPerTarget = 0f;
        }
        else if (!lookAtIsPos)
                ...
                else
                {
                    ...
                    if ((bool)hitTransform)
                    {
                        ...
                        if ((bool)(UnityEngine.Object)(object)component)
                        {
                            ...
                            {
                                component.AddForceAtPosition(vector, forceWorldPos - Origin.position, (ForceMode)1);
                            }
                            else
                            {
    ...
    public bool StartRagdoll(float stunTime)
    {
        ...
        if (!(UnityEngine.Object)(object)ragdollAnimator)
        {
            return false;
        }
        ...
        ragdollAnimator.cullingMode = (AnimatorCullingMode)0;
        ragdollAnimator.keepAnimatorStateOnDisable = true;
        ((Behaviour)(object)ragdollAnimator).enabled = false;
        Animation component = GetModelTransform().GetComponent<Animation>();
        if ((bool)(UnityEngine.Object)(object)component)
        {
            component.cullingType = (AnimationCullingType)0;
    ...
    public void SetRagdollDead()
    {
        ...
        for (int i = 0; i < ragdollPoses.Count; i++)
        {
            ...
            if ((bool)(UnityEngine.Object)(object)rb)
            {
    ...
    public void DisableRagdoll(bool isSetAlive)
    {
        ...
        if (!isSetAlive && !entity.IsDead())
        {
            ...
            ragdollAnimator.keepAnimatorStateOnDisable = true;
            int num2 = (ragdollIsPlayer ? 5 : 0);
            ragdollAnimator.CrossFadeInFixedTime(text, 0.25f, num2, 2f, 0f);
    ...
    public void CaptureRagdollZeroBones()
    {
        ...
        {
            if (!(UnityEngine.Object)(object)parent.GetComponent<Rigidbody>())
            {
    ...
    public void BlendRagdoll()
    {
        if (ragdollAdjustPosDelay > 0f)
        {
            ...
            if (ragdollAdjustPosDelay <= 0f)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    if (!Physics.Raycast(vector2, Vector3.down, ref val, 3f, -538750981))
                    {
                        break;
                    }

                    RootTransformRefEntity component = ((RaycastHit)(ref val)).transform.GetComponent<RootTransformRefEntity>();
                    if (!component || component.RootTransform != entity.transform)
                    {
                        vector2.y = ((RaycastHit)(ref val)).point.y + 0.02f;
                        break;
                    }

                    vector2.y = ((RaycastHit)(ref val)).point.y - 0.01f;
                }
    ...
    public void FrameUpdateRagdoll()
    {
        ...
        bool flag = entity.IsDead();
        if ((bool)(UnityEngine.Object)(object)pelvisRB && IsRagdollMovement)
        {
            if (!flag && entity.isEntityRemote)
            {
                Vector3 position = pelvisRB.position;
                Vector3 vector = entity.targetPos - Origin.position;
                pelvisRB.AddForce((0f - serverPosSpringForce) * (position - vector) - serverPosSpringDamping * pelvisRB.velocity, (ForceMode)5);
            }
        ...
        switch (ragdollState)
        {
            ...
            case ERagdollState.BlendOutGround:
                ...
                if (ragdollTime >= 0.25f)
                {
                    ...
                    {
                        text = "CrawlerGetUpChest";
                    }

                    int num = (ragdollIsPlayer ? 5 : 0);
                    ragdollAnimator.CrossFade(text, 0.3f, num);
    ...
    public void ClothSimInit()
    {
        ...
        if (clothSim != null)
        {
            ...
            {
                ((Component)(object)clothSim[num]).gameObject.SetActive(value: false);
            }
    ...
    public void ClothSimOn(bool _on)
    {
        if (clothSim != null && isClothSimOn != _on)
        {
            ...
            for (int num = clothSim.Length - 1; num >= 0; num--)
            {
                ((Component)(object)clothSim[num]).gameObject.SetActive(_on);
            }
        }
    }
    ...
    public virtual void SwitchModelAndView(bool _bFPV, bool _bMale)
    {
        if (GetModelTransform() != null)
        {
            ...
            if ((UnityEngine.Object)(object)component != null)
            {
                ((Behaviour)(object)component).enabled = !_bFPV;
            }
        }
        ...
        if (transform != null)
        {
            ...
            {
                ((Behaviour)(object)component2).enabled = !IsFPV;
            }
    ...
    public void SetColliderLayers(Transform modelT, int layer)
    {
        ...
        for (int i = 0; i < componentsInChildren.Length; i++)
        {
            GameObject gameObject = ((Component)(object)componentsInChildren[i]).gameObject;
        ...
        {
            ((Component)(object)componentsInChildren2[j]).gameObject.layer = layer;
        }
    }
    ...
    public virtual void SetAlive()
    {
        ...
        if ((bool)transform)
        {
            ...
            if ((UnityEngine.Object)(object)component != null)
            {
                ((Behaviour)(object)component).enabled = !IsFPV;
            }
        }
    ...
    public virtual void createModel(World _world, EntityClass _ec)
    {
        ...
        {
            ParticleSystem val = DataLoader.LoadAsset<ParticleSystem>(_ec.particleOnSpawn.fileName, _ignoreDlcEntitlements: false);
            if ((UnityEngine.Object)(object)val != null)
            {
                ParticleSystem val2 = UnityEngine.Object.Instantiate<ParticleSystem>(val);
                ((Component)(object)val2).transform.parent = modelTransformParent;
                if (_ec.particleOnSpawn.shapeMesh != null && _ec.particleOnSpawn.shapeMesh.Length > 0)
                {
                    ...
                    if (text.Contains("setshapetomesh"))
                    {
                        ...
                        {
                            ((ShapeModule)(ref shape)).skinnedMeshRenderer = componentsInChildren[num];
                            ParticleSystem[] componentsInChildren2 = ((Component)(object)val2).transform.GetComponentsInChildren<ParticleSystem>();

...
public class NetPackageAudio : NetPackage
{
    ...
    {
        base.write(_writer);
        ((BinaryWriter)_writer).Write(playOnEntityId);
        ((BinaryWriter)_writer).Write((soundGroupName != null) ? soundGroupName : "");
        ((BinaryWriter)_writer).Write(play);
        ((BinaryWriter)_writer).Write(position.x);
        ((BinaryWriter)_writer).Write(position.y);
        ((BinaryWriter)_writer).Write(position.z);
        ((BinaryWriter)_writer).Write(playOnEntity);
        ((BinaryWriter)_writer).Write(occlusion);
        ((BinaryWriter)_writer).Write(signalOnly);
    }

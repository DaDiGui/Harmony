...
public class XUiC_WorkstationWindowGroup : XUiC_CraftingWindowGroup
{
    ...
    public override void Update(float _dt)
    {
        ...
        if (windowGroup.isShowing)
        {
            ...
            if (!((OneAxisInputControl)base.xui.playerUI.playerInput.PermanentActions.Activate).IsPressed)
            {
                wasReleased = true;
            }
            ...
            if (wasReleased)
            {
                ...
                if (((OneAxisInputControl)base.xui.playerUI.playerInput.PermanentActions.Activate).WasReleased && activeKeyDown)
                {
                    activeKeyDown = false;

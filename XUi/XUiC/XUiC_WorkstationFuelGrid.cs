...
public class XUiC_WorkstationFuelGrid : XUiC_WorkstationGrid
{
    ...
    public override void Update(float _dt)
    {
        ...
        if (((OneAxisInputControl)base.xui.playerUI.playerInput.GUIActions.WindowPagingRight).WasPressed && PlatformManager.NativePlatform.Input.CurrentInputStyle != PlayerInputManager.InputStyle.Keyboard)
        {

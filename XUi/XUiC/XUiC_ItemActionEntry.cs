...
public class XUiC_ItemActionEntry : XUiController
{
    ...
    public BaseItemActionEntry ItemActionEntry
    {
        ...
        set
        {
            ...
            if (itemActionEntry != null)
            {
                PlayerAction action = (PlayerAction)(itemActionEntry.ShortCut switch
                {
    ...
    public override bool GetBindingValue(ref string value, string bindingName)
    {
        switch (bindingName)
        {
            ...
            case "statuscolor":
                ...
                return true;
            case "inspectheld":
                value = ((itemActionEntry != null && ((OneAxisInputControl)base.xui.playerUI.playerInput.GUIActions.Inspect).IsPressed) ? "true" : "false");
                return true;
            default:
                return false;
        }

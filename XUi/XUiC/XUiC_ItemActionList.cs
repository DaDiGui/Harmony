    ...
    public override void Update(float _dt)
    {
        ...
        if (base.ViewComponent.UiTransform.gameObject.activeInHierarchy)
        {
            ...
            if (PlatformManager.NativePlatform.Input.CurrentInputStyle != PlayerInputManager.InputStyle.Keyboard || !base.xui.playerUI.windowManager.IsInputActive())
            {
                ...
                {
                    if (entryList[j].ItemActionEntry != null && (PlatformManager.NativePlatform.Input.CurrentInputStyle == PlayerInputManager.InputStyle.Keyboard || ((OneAxisInputControl)gUIActions.Inspect).IsPressed) && ((((OneAxisInputControl)gUIActions.DPad_Up).WasPressed && entryList[j].ItemActionEntry.ShortCut == BaseItemActionEntry.GamepadShortCut.DPadUp) || (((OneAxisInputControl)gUIActions.DPad_Right).WasPressed && entryList[j].ItemActionEntry.ShortCut == BaseItemActionEntry.GamepadShortCut.DPadRight) || (((OneAxisInputControl)gUIActions.DPad_Down).WasPressed && entryList[j].ItemActionEntry.ShortCut == BaseItemActionEntry.GamepadShortCut.DPadDown) || (((OneAxisInputControl)gUIActions.DPad_Left).WasPressed && entryList[j].ItemActionEntry.ShortCut == BaseItemActionEntry.GamepadShortCut.DPadLeft)))
                    {

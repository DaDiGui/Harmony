            ...
            case StreamModeWrite.Persistency:
                {
                    ...
                    ((BinaryWriter)_bw).Write((byte)fuel.Length);
                    for (int m = 0; m < fuel.Length; m++)
                    {
                        fuel[m].Write(_bw);
                    }

                    ((BinaryWriter)_bw).Write((byte)input.Length);
                    ...
                    mold.Write(_bw);
                    output.Write(_bw);
                    ((BinaryWriter)_bw).Write(fuelInForgeInTicks);
                    ((BinaryWriter)_bw).Write((short)moldedMetalSoFar);
                    ((BinaryWriter)_bw).Write((short)metalInForge);

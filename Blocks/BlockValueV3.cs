...
public struct BlockValueV3
{
    ...
    public int type
    {
        ...
        set
        {
            rawData = (rawData & 0xFFFF8000u) | (uint)(int)((ulong)value & 0x7FFFuL);
        }
    }
    ...
    public byte meta2and1
    {
        ...
        set
        {
            meta2 = (byte)((uint)(value >> 4) & 0xFu);
            meta = (byte)(value & 0xFu);
        }
    }
    ...
    public int parentx
    {
        get
        {
            ...
            return (((uint)num & 8u) != 0) ? (-(num & 7)) : (num & 7);
        }
        set
        {
    ...
    public int parenty
    {
        get
        {
            ...
            return (((uint)num & 0x20u) != 0) ? (-(num & 0x1F)) : (num & 0x1F);
        }
        set
        {

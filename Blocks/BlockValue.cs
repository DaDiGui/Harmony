...
public struct BlockValue : IEquatable<BlockValue>
{
    ...
    public int type
    {
        ...
        set
        {
            rawData = (rawData & 0xFFFF0000u) | ((uint)value & 0xFFFFu);
        }
    }
    ...
    public bool hasdecal
    {
        ...
        set
        {
            rawData = (rawData & 0x7FFFFFFFu) | (value ? 2147483648u : 0u);
        }
    }
    ...
    public BlockFace decalface
    {
        ...
        get
        {
            return (BlockFace)((rawData >> 22) & 0xFu);
        }
        set
        {
    ...
    public bool ischild
    {
        ...
        set
        {
            rawData = (rawData & 0xBFFFFFFFu) | (value ? 1073741824u : 0u);
        }
    }
